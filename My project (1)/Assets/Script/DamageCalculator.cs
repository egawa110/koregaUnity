...
public class DamageCalculator : MonoBehaviour
{
    ...
    public static bool StrongAttack(Vector3 velocity, bool strongflag, int power) //強攻撃
    {
        //強攻撃
    ...
    public static bool LightAttack(Vector3 velocity, bool lightflag, int power) //弱攻撃
    {
        //強攻撃
        if (Mathf.Abs(velocity.x) > m_strongspeed ||
            Mathf.Abs(velocity.z) > m_strongspeed){
